...
import { PartnersTable, PartnerCollectionsTable } from "@/components/data-table"
                ...
                <div className="rounded-md border">
                    ...
                    <tbody>
                        ...
                        <tr className="[&>td]:whitespace-nowrap dark:[&>td]:hover:bg-gray-400">
                            ...
                            <td className="border px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right">{partner.rel_path}</td>
                        </tr>
                    </tbody>
                </table>
                </div>
